  ...
  <div className="flow">
    ...
    <div className="cols-2">
      ...
      <p>
        ...
        <code>element</code> property set to <code>circle</code>.
        Additional properties should be included for <code>cx</code>,{' '}
        <code>cy</code> and <code>r</code>. Any other properties can be
        included as attributes for the generated SVG <code>circle</code> element.
      </p>
    ...
    <p className="cols-2">
      The short form of this is an object with a <code>circle</code> property
    ...
    <p className="cols-2">
      The even shorter form is to define the icon as a single string with
      the <code>circle</code> prefix, a colon, and then the parameters
      for <code>cx</code>, <code>cy</code> and <code>r</code>.
    </p>
    <Example
      Component={String}
      code={StringSrc}
